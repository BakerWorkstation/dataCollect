...
def logthread(cycle, number):
    ...
    #filelog = FileManage()
    trans = JsonFormat()
    sendlog = SyslogManage(ip="127.0.0.1", port=515)
    #while True:
    # 从本地获得推送日志
    ...
    #message = 'Sep 24 17:00:41 2812036182004138(root) 46083623 Traffic@FLOW: NAT: 10.130.11.205:1->39.96.252.213:5813(ICMP: ECHO_REQUEST), snat to 223.71.99.2:39308, vr trust-vr, user -@UNKNOWN, host -, rule 12\n\x00'
