'''
@Author: your name
@Date: 2020-05-20 15:27:14
@LastEditTime: 2020-05-20 15:27:15
@LastEditors: your name
@Description: In User Settings Edit
@FilePath: /opt/DataCollect/webapi/utils/hbaseApi.py
'''
...
def main():
    ...
    #hBase.scanTable()
    # # 获取数据
    #rowkey = "zJ7o_63526102809102_syslog"
